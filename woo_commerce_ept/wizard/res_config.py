...
class ResConfigSettings(models.TransientModel):
    ...
    woo_weight_uom_id = fields.Many2one("uom.uom", string="WooCommerce Weight Unit",
                                        ...
                                        help="Select Weight unit same as WooCommerce Store for setting proper Weight "
                                             "in Product.")
    ...
    woo_stock_export_warehouse_ids = fields.Many2many('stock.warehouse', 'woo_stock_export_warehouse_rel',
                                                      string="Stock Export Warehouse")
    ...
    def onchange_woo_instance_id(self):
        ...
        if instance:
            ...
            self.woo_analytic_account_id = instance.woo_analytic_account_id.id if instance.woo_analytic_account_id else False
